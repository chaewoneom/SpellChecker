...
//                   shouldBeCaps = (punctuation == '.' || punctuation == '?' || punctuation == '!'); 
     ...
     */
    public boolean misspellingCorrection(String word, correctionData e, boolean shouldBeCaps) {
     ...
     * @return boolean true to indicate if possible corrections were found else false
     */
    public boolean miscapitalizationCorrection(raw_string word, correctionData e, boolean shouldBeCaps) {
        int numFoundErrors = (e.getCorrections() != null) ? e.getCorrections().size() : 0;
        raw_string str = word;
        String string;
     ...
     * for corrections                     *
     * *************************************/
    public static class raw_string {
